...
{
    double s = amount * 0.20;
    finalamount = amount - s;
    Console.WriteLine($" 20% discount finalamount= {finalamount}");
}
else if (amount >= 300 && amount < 499)
{
  

    double s = amount *0.10 ;
    finalamount = amount - s ;
    Console.WriteLine($" 10% discount finalamount= {finalamount}");
}
